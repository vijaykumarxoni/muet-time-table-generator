		...
		<div class="block-header">
			<div class="row">
				<div class="col-lg-7 col-md-6 col-sm-12">
					<h2>
						Slots Approve Or Discard <small>Welcome to MUET Time Table</small>
					</h2>
				</div>
				<div class="col-lg-5 col-md-6 col-sm-12">
					<ul class="breadcrumb float-md-right">
						...
						<li class="breadcrumb-item active">Slot Approve</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="card action_bar">
						<div class="body">
							...
							<div class="row clearfix">
								...
								<input type="button" id="noti" data-toggle="modal" data-target="#defaultModal"    class="btn btn-info" value="Notification"
											>
											</div>
											</div>
									...
									<div class="col-lg-2 col-md-2 col-2">
									<div class="input-group search">
								<input type="button" id="approve" data-toggle="modal" data-target="#defaultModal"    class="btn btn-success" value="Approve"
											>
											</div>
											</div>	
								<div class="col-lg-2 col-md-2 col-2">
									...
									<input type="button" id="discard"     class="btn btn-danger" value="Discard" /> 
									</div>
								</div>
