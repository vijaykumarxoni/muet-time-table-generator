        ...
        <div class="row clearfix">
           ...
           <!-- Badges -->
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Basic</strong> <small></small> </h2>
                       
                    </div>
                    <div class="body">
                        <ul class="list-group">
                            <a href="semester"><li class="list-group-item">Edit Running Semeter</li> </a>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Departmental</strong> Settings  </h2>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Main</strong> Settings  </h2>
                   
                    </div>
                    <div class="body">
                        <ul class="list-group">
                            <li class="list-group-item"><a href="day">Day (Add , Update , View)</a>      </li>
                            
                            <li class="list-group-item"><a href="timeSlotDaily">Time Slot Daily (Add , Update , View)</a></li>
