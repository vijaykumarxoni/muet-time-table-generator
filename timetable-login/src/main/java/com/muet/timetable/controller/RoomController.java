...
//	 
	...
	@RequestMapping("")
	public String DepartmentPage(Model modele, Principal principal) {
	...
	public ResponseEntity<?> getTotal(@RequestParam(defaultValue = "0") int page, Principal principal) {
		...
		return ResponseEntity.ok(roomDAOImpl.getAllRecordsByDept(department).size());
	...
	public ResponseEntity<?> getTotal() {
		...
		return ResponseEntity.ok(roomDAOImpl.getAllRecords().size());
